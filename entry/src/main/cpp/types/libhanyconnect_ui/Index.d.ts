...
export declare function applyE2EConfig(configJson: string): string
...
export declare function e2EConnectActive(): Promise<string>

export declare function e2EDisconnect(): Promise<string>
