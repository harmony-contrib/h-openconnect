...
force-global-desc = Ignore split-tunnel; send all IPv4 via VPN
...
feedback-connected = VPN connected
...
about-privacy-no-telemetry = The app contains no analytics or telemetry upload; network requests are initiated by your configured VPN and authentication flow.
...
conn-local-lan = Keep local network reachable while VPN is up
